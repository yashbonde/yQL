...
app.add_api_route("/SayHello", predict, methods=["POST"], response_class=JSONResponse)
app.add_api_route("/SayHello_json", predict_json, methods=["POST"], response_class=JSONResponse)

...
app.add_api_route("/GetIceCream_json", predict_json, methods=["POST"], response_class=JSONResponse)
app.add_api_route("/ThrowIceCream", predict, methods=["POST"], response_class=JSONResponse)
app.add_api_route("/ThrowIceCream_json", predict_json, methods=["POST"], response_class=JSONResponse)
